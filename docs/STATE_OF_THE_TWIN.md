...
| twin_wigner_tomography | raw-data demo | n/a | end-to-end Wigner tomography of a displaced state (twin-simulated SDF/Ramsey χ-readout + shot noise → raw data → reconstructed W); worked example [examples/wigner_tomography](examples/wigner_tomography/README.md) |
